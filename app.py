...
class TextPreprocessor:
    def __init__(self):
        ...
        # [PERBAIKAN]: Penambahan Custom Stopwords baru berdasarkan analisis data
        self.custom_stopwords = {
            ...
            # --- TAMBAHAN BARU ---
            's', '500', '1500', 'error', 'server', 'please', 'try', 'later', 'know',
            'laku', 'tuju', 'antar', 'hubung', 'guna', 'makin', 
            'dulu', 'udah', 'utk', 'kalo', 'krn', 'pdhl', 
            'bandara', 'changi', 'tanah', 'merah', 'resort', 'front', 'harbourfront', 'mega', 'megamall', 
            'menyeberang', 'nyebrang', 'lewat', 'tiba', 'langsung',
            'pengalaman', 'lainnya', 'biasanya', 'sebelumnya', 'akhirnya', 'memiliki', 'terdapat', 'tersedia', 'pilihan', 'berada', 'macam', 
            # Kata sifat perubah sentimen seperti 'lumayan', 'sedikit', 'kurang' TIDAK dimasukkan ke sini agar model SVM tetap bisa membacanya
        }
